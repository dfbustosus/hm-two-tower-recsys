...
LINEAR_FEATURE_NAMES = (
    ...
    "has_recent_popularity_1d",
    "recent_popularity_1d_score",
    "recent_popularity_1d_rank_reciprocal",
    "has_recent_popularity_3d",
    "recent_popularity_3d_score",
    "recent_popularity_3d_rank_reciprocal",
    ...
    "has_seasonal_popularity",
    "seasonal_popularity_score",
    "seasonal_popularity_rank_reciprocal",
    ...
    "has_product_code_popularity",
    "product_code_popularity_score",
    "product_code_popularity_rank_reciprocal",
    "has_content_similarity",
    "content_similarity_score",
    "content_similarity_rank_reciprocal",
    "has_text_similarity",
    "text_similarity_score",
    "text_similarity_rank_reciprocal",
    "has_item2vec_similarity",
    "item2vec_similarity_score",
    "item2vec_similarity_rank_reciprocal",
    "has_two_tower_retrieval",
    "two_tower_retrieval_score",
    "two_tower_retrieval_rank_reciprocal",
    "has_two_tower_retrieval_latest_customer",
    "two_tower_retrieval_latest_customer_score",
    "two_tower_retrieval_latest_customer_rank_reciprocal",
    "source_count_scaled",
...
def feature_vector(features: CandidateFeatures) -> tuple[float, ...]:
    ...
    return (
        ...
        float(features.has_recent_popularity_1d),
        features.recent_popularity_1d_score,
        _rank_reciprocal(features.recent_popularity_1d_rank),
        float(features.has_recent_popularity_3d),
        features.recent_popularity_3d_score,
        _rank_reciprocal(features.recent_popularity_3d_rank),
        ...
        float(features.has_seasonal_popularity),
        features.seasonal_popularity_score,
        _rank_reciprocal(features.seasonal_popularity_rank),
        ...
        float(features.has_product_code_popularity),
        features.product_code_popularity_score,
        _rank_reciprocal(features.product_code_popularity_rank),
        float(features.has_content_similarity),
        features.content_similarity_score,
        _rank_reciprocal(features.content_similarity_rank),
        float(features.has_text_similarity),
        features.text_similarity_score,
        _rank_reciprocal(features.text_similarity_rank),
        float(features.has_item2vec_similarity),
        features.item2vec_similarity_score,
        _rank_reciprocal(features.item2vec_similarity_rank),
