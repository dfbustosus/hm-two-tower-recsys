...
def test_write_deterministic_ranker_submission_report(tmp_path: Path) -> None:
    ...
    report = build_deterministic_ranker_submission_report(
        ...
        include_seasonal_popularity=False,
        seasonal_shift_days=None,
        seasonal_window_days=None,
        ...
        include_two_tower_retrieval=False,
        two_tower_source_name=None,
        two_tower_max_retrieval_articles=None,
